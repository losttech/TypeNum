namespace TypeNum {
    ...
    public struct N2 : INumeral { public int Num => 2; }
    ...
    public struct N4 : INumeral { public int Num => 4; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N8 : INumeral { public int Num => 8; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N16 : INumeral { public int Num => 16; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N32 : INumeral { public int Num => 32; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N64 : INumeral { public int Num => 64; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N128 : INumeral { public int Num => 128; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N256 : INumeral { public int Num => 256; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N512 : INumeral { public int Num => 512; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N1024 : INumeral { public int Num => 1024; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N2048 : INumeral { public int Num => 2048; }
    [StructLayout(LayoutKind.Sequential)]
    ...
    public struct N4096 : INumeral { public int Num => 4096; }
    [StructLayout(LayoutKind.Sequential)]
